...
export const paintings: Painting[] = [
    ...
    },
    {
        ...
        description: 'Conociendo de dónde venimos, añorando a nuestros ancestros, venerando nuestro punto de partida, jamás perderemos nuestra meta, pues para dirigirnos a nuestro Norte, es preciso conocer bien nuestro Sur.',
        artist: {
            id: 'andres-kaliman',
            name: 'Andrés Kaliman',
            biography: `Estudios:
    ...
    },
    {
        ...
        method: 'Oleo',
        description: 'Representación de la cultura tarijeña, plasmando en su fondo el cañón de la Angostura, zona vitivinícola por excelencia. También se puede apreciar tres chunchos, un racimo de uva y un chapaco tocando la tradicional caña con su vestimenta típica de sombrero y poncho rojo.',
        artist: {
    ...
    },
    {
        ...
        location: 'Ciudad de Tarija - Bolivia',
        method: 'Acrílico',
        description: 'Obra pintada en un mes de abril, mes aniversario de Tarija, pensada en la alegría de compartir entre amigos, risas, música y baile, atesorando momentos que se van quedando por siempre en el alma.',
        artist: {
